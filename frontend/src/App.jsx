...
import TrionnIntro from './components/TrionnIntro';
...
export default function App() {
  const [page,setPage]=useState(resolvePage); const [nodes,setNodes]=useState(['Node01']); const [selectedNode,setSelectedNode]=useState('Node01'); const [nodesSummary,setNodesSummary]=useState([]); const [mobileNav,setMobileNav]=useState(false); const [showIntro, setShowIntro] = useState(true);
